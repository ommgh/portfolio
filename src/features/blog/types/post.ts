export type PostMetadata = {
  ...
  pinned?: boolean;
  /**
   * Flag to hide the post from blog listings while keeping it accessible via direct URL.
   * Useful for multi-part posts where only the first part should appear in listings.
   */
  unlisted?: boolean;
  /**
